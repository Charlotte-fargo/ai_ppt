...
AI_SYSTEM_PROMPT_en = """
        ...
        Task Requirements:
        1. Generate investment views for 7 asset classes: HK/China Equities, US Equities, EU Equities, Japan Equities, Fixed Income, Gold, and Crude Oil. If a specific asset class is missing in the documents, infer reasonably from your knowledge base or mark it as "No Data Available". Strictly follow the output format below.Asset Title: Must be maximum 6 words. Format: "Asset Class: [Core View Summary]".For Asset:HK/China Equities,must be 5 words including HK/China Equities. Investment Rationale (Summary Logic): Must be approximately 22 words. This should be a high-level concise summary.AND Each bullet point minimum 22 words or 180 characters.
