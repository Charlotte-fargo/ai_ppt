...
def run_ai_job(token, context_text,API_BASE_URL):
    ...
    任务要求：
    1. 生成7种资产的投资观点（中港股市、美股、欧股、日股、债市、黄金、原油）。如果提供的文档中缺少某种资产，请根据你的知识库合理推断或标记为"暂无数据",中港股市和黄金的投资逻辑中文字数必须在80字，其中美股，欧股投资逻辑的字数控制在55字以内，其中关于原油，日股和债市的投资逻辑的字数控制在50字以内，以下生成的每一个bullet point字数控制在70字左右，三个bullet point总字数苏要在250。
    2. 严格遵循以下输出格式。
